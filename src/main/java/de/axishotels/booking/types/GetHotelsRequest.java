...
/**
 *  GetHotelsRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetHotelsRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://axishotels.de/booking/types",
            "GetHotelsRequest", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetHotelsRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetHotelsRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetHotelsRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetHotelsRequest object = new GetHotelsRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetHotelsRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetHotelsRequest) de.axishotels.booking.types.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
