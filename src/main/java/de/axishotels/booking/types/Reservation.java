...
public class Reservation implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected java.util.Date localArrivalDate;

    /**
     * field for DepartureDate
     */
    protected java.util.Date localDepartureDate;
     ...
     */
    public void setArrivalDate(java.util.Date param) {
     ...
     */
    public void setDepartureDate(java.util.Date param) {
    ...
    public static class Factory {
         ...
         */
        public static Reservation parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Reservation".equals(type)) {
                            ...
                            return (Reservation) de.axishotels.booking.types.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://axishotels.de/booking/types", "arrivalDate").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "arrivalDate" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setArrivalDate(org.apache.axis2.databinding.utils.ConverterUtil.convertToDate(
                            content));
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "departureDate" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setDepartureDate(org.apache.axis2.databinding.utils.ConverterUtil.convertToDate(
                            content));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://axishotels.de/booking/types",
                            "numberOfRooms").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "numberOfRooms" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setNumberOfRooms(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            content));
